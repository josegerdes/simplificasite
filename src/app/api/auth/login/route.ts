...
/** Cookie `Secure` só é aceito em HTTPS — basear isso em `NODE_ENV` quebra
 *  silenciosamente atrás de proxy sem HTTPS configurado (ex: Dokploy sem
 *  domínio/SSL ainda). Detecta o protocolo pelo header do proxy reverso. */
